## 3.5: data.table
# data.table package is one of the most popular data wrangling and analysis pacakges.
# It is a separate package from tidyverse, so it will need to be installed. 
...
# the first step when using data.table is to convert the data frame into a data.table object using the DT function
